...
export default function DeleteContratModal({ open, onClose, onConfirm   }: { open: boolean; onClose: () => void; onConfirm: ()=> void  }) {
  return (
    <Modal
      open={open}
      onClose={onClose}
        ...
        <div className='flex gap-5 items-center '> 
         ...
         <button onClick={onClose} className=' text-[20px] gap-10 cursor-pointer '>x</button>
          ...
          <div className="flex justify-end gap-2 mt-5">  
            ...
            <button
              type="button"
              className=" cursor-pointer font-bold text-[1.6rem] px-4 py-2 rounded bg-[#F08130]"
              onClick={onConfirm}
            >
              Supprimer
            </button>
...
//                         console.log(selectedSite?.numeroSite)
//                         console.log(selectedSite);
//                         if (selectedSite) {
//                           setFormData(prev => ({
//                             ...prev,    
//                              siteId: selectedSite.numeroSite,
